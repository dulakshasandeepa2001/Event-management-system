         ...
         <div className="border-t border-gray-700">
            <div className="p-4 space-y-2">
               <NavLink
                  ...
                  className={({isActive})=>`${isActive ? "bg-blue-500/20 border-blue-500":"border-gray-700"}
                     w-full flex items-center space-x-3 px-4 py-2 rounded border hover:border-blue-500 transition`}
               >
