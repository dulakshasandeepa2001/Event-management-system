...
const StudentSidebar = () => {
  ...
  const links = [
    ...
    { to: '/student-dashboard/list-event', icon: <FaCalendarAlt />, label: 'Events' },
    { to: '/student-dashboard/list-marks', icon: <FaGraduationCap />, label: 'Exam Results' },
    { to: '/student-dashboard/submissions', icon: <FaFileUpload />, label: 'Submissions' },
    { to: '/student-dashboard/mental-health', icon: <FaHeart />, label: 'Mental Health' },
  ];
      ...
      <div className="flex h-full flex-col justify-between p-4 lg:p-5">
        <div>
          <div className={brandCardClassName}>
            ...
            <p className="mt-1 text-xs text-slate-400">Student Panel</p>
          </div>
          ...
          <div className={helperCardClassName}>
            ...
            <p className="mt-1 text-xs text-slate-400">
              Check your submissions, results, and notifications from here.
            </p>
            <button className={helperButtonClassName}>Open Dashboard</button>
          </div>
        </div>
